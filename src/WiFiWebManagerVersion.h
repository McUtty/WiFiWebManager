...
#define WIFIWEB_MANAGER_VERSION "3.0.2"
#define WIFIWEB_MANAGER_VERSION_MAJOR 3
#define WIFIWEB_MANAGER_VERSION_MINOR 0
#define WIFIWEB_MANAGER_VERSION_PATCH 2
...
#define WIFIWEB_MANAGER_FEATURE_STATUS_LED 1
